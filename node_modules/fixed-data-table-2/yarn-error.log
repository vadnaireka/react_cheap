Arguments: 
  /usr/local/bin/node /usr/share/yarn/bin/yarn.js add --dev @babel/preset-plugin-transform-flow-strip-types

PATH: 
  /usr/lib/postgresql/10/bin/:/home/pradeep/project/node-packages/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/usr/lib/jvm/java-8-oracle/bin:/usr/lib/jvm/java-8-oracle/db/bin:/usr/lib/jvm/java-8-oracle/jre/bin
...
Trace: 
  Error: https://registry.yarnpkg.com/@babel%2fpreset-plugin-transform-flow-strip-types: Not found
...
Lockfile: 
  ...
  lodash@^4.17.10, lodash@^4.17.11, lodash@^4.17.2, lodash@^4.17.4, lodash@^4.2.1, lodash@^4.3.0:
    version "4.17.11"
